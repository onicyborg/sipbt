...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4">List Monitoring Bibit</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Monitoring Bibit</li>
        </ol>
        <div class="card mb-4">
            <div class="card-header">
                List Monitoring Bibit Pesanan Pelanggan
            </div>
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
                                            title="Cek Detail Monitoring">
                                            <a href="/pegawai/monitoring-bibit/detail/{{ $item->id }}"
                                                class="btn btn-secondary"><i class="fa-solid fa-seedling"></i></a>
                                        </span>
                                    </td>
                                </tr>
                            @endforeach

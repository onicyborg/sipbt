...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <a class="btn btn-primary" href="/pemilik/product/add"><i class="fa-solid fa-plus"></i>
                    Tambah Data</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="/pemilik/product/update/{{ $item->id }}" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-3">

            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="/logout-pemilik">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link <?php if($menu == 'dashboard'){ echo 'active'; } ?>" href="/pemilik/dashboard">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-gauge"></i></div>
                                Dashboard
                            </a>
                            <a class="nav-link <?php if($menu == 'produkbibit'){ echo 'active'; } ?>" href="/pemilik/produk-bibit">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-boxes-stacked"></i></i></div>
                                Produk Bibit
                            </a>
                            <a class="nav-link <?php if($menu == 'laporanpenjualan'){ echo 'active'; } ?>" href="/pemilik/laporan-penjualan">
